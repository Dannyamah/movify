...
<div id="login-register-popup" class="small-dialog zoom-anim-dialog mfp-hide">
    ...
    <div class="signin-wrapper">
        ...
        <div class="small-dialog-content">
            ...
            <!-- Start of Login form -->
            <form id="cariera_login" action="login_action.php" method="post">
                <p class="status"></p>

                <div class="form-group">
                    <label for="email">Email *</label>
                    <input type="text" class="form-control" id="username" name="email" placeholder="Your Email *" />
                </div>
                ...
                <div class="form-group">
                    <button  value="Sign in" class="btn btn-main btn-effect nomargin"> Sign IN </button>
                </div>
            </form>
            <!-- End of Login form -->
