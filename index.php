            ...
            <div class="item">
                ...
                <div class="movie-box-1">
                    ...
                    <div class="movie-details">
                        ...
                        <!-- sending data to a page on php use a ? after the page href the create a variable and set the detail of the  -->
                            <a href="movie-detail.php?id=<?php echo $movie['id']; ?>"> <?php echo $movie['title']; ?> </a>
                        </h4>
